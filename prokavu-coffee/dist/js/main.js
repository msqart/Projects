...
/*popup*/
if (popup.length > 0) {
    __webpack_require__(/*! ./modules/popup */ "./src/js/modules/popup.js")(popup);
}

/*form data*/
if (arrFormData.length > 0) {
    (__webpack_require__(/*! ./modules/feedback */ "./src/js/modules/feedback.js"))(arrFormData);
}
/*scroll to*/
if (nav !== null) {
    __webpack_require__(/*! ./modules/scrollTo */ "./src/js/modules/scrollTo.js")(nav);
}
/*parallax*/
if (parallax.length > 0) {
    __webpack_require__(/*! ./modules/scrollParallax */ "./src/js/modules/scrollParallax.js")(parallax);
}
/*mobile menu*/
if (nav !== null) {
    __webpack_require__(/*! ./modules/mobileMenu */ "./src/js/modules/mobileMenu.js")(header, nav, burgerMenu);
}
/*header scroll*/
if (header !== null) {
    __webpack_require__(/*! ./modules/topMenu */ "./src/js/modules/topMenu.js")(header, nav);
}
/*gallery slider*/
if (gallerySlider !== null) {
    __webpack_require__(/*! ./modules/gallerySlider */ "./src/js/modules/gallerySlider.js")(gallerySlider, sliderControls);
}
/*open img gallery*/
if (gallerySlider !== null) {
    __webpack_require__(/*! ./modules/openImg */ "./src/js/modules/openImg.js")(gallerySlider);
}
...
if (coffeeSlider.length > 0) {
    const glide = new _glidejs_glide__WEBPACK_IMPORTED_MODULE_0__["default"]('.list_coffee_slider', {
        gap: 0,
        type: 'carousel',
        startAt: 0,
        perView: 3,
...
module.exports = (arr) => {
    const xhr = new (__webpack_require__(/*! xhr-promise */ "./node_modules/xhr-promise/index.js"))();
    const encode = __webpack_require__(/*! ./functions/encode */ "./src/js/modules/functions/encode.js");
    const hiddenScroll = __webpack_require__(/*! ./functions/hiddenScroll */ "./src/js/modules/functions/hiddenScroll.js");
...
/***/ "./src/js/modules/functions/encode.js":
/*!********************************************!*\
  !*** ./src/js/modules/functions/encode.js ***!
  \********************************************/
/*! no static exports found */
...
/***/ "./src/js/modules/functions/hiddenScroll.js":
/*!**************************************************!*\
  !*** ./src/js/modules/functions/hiddenScroll.js ***!
  \**************************************************/
/*! no static exports found */
...
module.exports = (header, nav, burgerMenu) => {
    ...
    const scrollFunc = __webpack_require__(/*! ./scrollToBlock */ "./src/js/modules/scrollToBlock.js");
    const objBlock = {};
...
/***/ "./src/js/modules/scrollParallax.js":
/*!******************************************!*\
  !*** ./src/js/modules/scrollParallax.js ***!
  \******************************************/
/*! no static exports found */
...
/***/ "./src/js/modules/scrollToBlock.js":
/*!*****************************************!*\
  !*** ./src/js/modules/scrollToBlock.js ***!
  \*****************************************/
/*! no static exports found */
